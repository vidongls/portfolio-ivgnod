...
export default function Home() {
  useGSAP(() => {
    ...
    //       let panelStarts = tops.map((st: any) => st.start), // an Array of all the starting scroll positions. We do this on each scroll to make sure it's totally responsive. Starting positions may change when the user resizes the viewport
